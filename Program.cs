...
namespace BilbasenKonsol
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                new ElectricCar("Ford", "Mustang", 1999, "Red", 430, 5),
...
//            GasolineCar gasCar = new GasolineCar("Toyota", "Corolla", 2020, "Red", 150, 4);
//            ElectricCar elecCar = new ElectricCar("Tesla", "Model S", 2022, "Black", 500, 100);
...
//                if (car is GasolineCar)
//                {
//                    GasolineCar gasolineCar = (GasolineCar)car;
//                    Console.WriteLine($"Number of Cylinders: {gasolineCar.NumberOfCylinders}");
//                }
